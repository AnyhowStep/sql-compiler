import {field, inline, precedence, seq, skipExpectationAfterExtraCost, skipExpectationCost, tokenSymbol, tokenSymbol2} from "../../grammar-builder";
 ...
 */
export const IntervalExpression = precedence(-1, seq(
