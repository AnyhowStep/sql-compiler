...
export interface MySqlRuleCollection {
    ...
    UserVariableIdentifierAssignment : Rule|TopLevelRuleModifier,
    ParamMarker : Rule|TopLevelRuleModifier,
    IntervalExpression : Rule|TopLevelRuleModifier,
    TemporalUnitTimeStamp : Rule|TopLevelRuleModifier,
    TemporalUnit : Rule|TopLevelRuleModifier,
    ...
    Not2SimpleExpression : Rule|TopLevelRuleModifier,
    PrefixSimpleExpression : Rule|TopLevelRuleModifier,
    ...
    ConflictFunctionCall : Rule|TopLevelRuleModifier,
    ...
    AsciiFunctionCall : Rule|TopLevelRuleModifier,
    CharSetFunctionCall : Rule|TopLevelRuleModifier,
    CoalesceFunctionCall : Rule|TopLevelRuleModifier,
    CollationFunctionCall : Rule|TopLevelRuleModifier,
    SchemaFunctionCall : Rule|TopLevelRuleModifier,
    IfFunctionCall : Rule|TopLevelRuleModifier,
    FormatFunctionCall : Rule|TopLevelRuleModifier,
    MicrosecondFunctionCall : Rule|TopLevelRuleModifier,
    ModFunctionCall : Rule|TopLevelRuleModifier,
    PasswordFunctionCall : Rule|TopLevelRuleModifier,
    QuarterFunctionCall : Rule|TopLevelRuleModifier,
    RepeatFunctionCall : Rule|TopLevelRuleModifier,
    ReplaceFunctionCall : Rule|TopLevelRuleModifier,
    ReverseFunctionCall : Rule|TopLevelRuleModifier,
    RowCountFunctionCall : Rule|TopLevelRuleModifier,
    TruncateFunctionCall : Rule|TopLevelRuleModifier,
    WeekFunctionCall : Rule|TopLevelRuleModifier,
    WeightStringFunctionCall : Rule|TopLevelRuleModifier,
    ContainsFunctionCall : Rule|TopLevelRuleModifier,
    GeometryCollectionFunctionCall : Rule|TopLevelRuleModifier,
    LineStringFunctionCall : Rule|TopLevelRuleModifier,
    MultiLineStringFunctionCall : Rule|TopLevelRuleModifier,
    MultiPointFunctionCall : Rule|TopLevelRuleModifier,
    MultiPolygonFunctionCall : Rule|TopLevelRuleModifier,
    PointFunctionCall : Rule|TopLevelRuleModifier,
    PolygonFunctionCall : Rule|TopLevelRuleModifier,
    AggregateFunctionCall : Rule|TopLevelRuleModifier,
    NumberAggregateFunctionCall : Rule|TopLevelRuleModifier,
    BitAggregateFunctionCall : Rule|TopLevelRuleModifier,
    StatisticalAggregateFunctionCall : Rule|TopLevelRuleModifier,
    JsonObjectAggregateFunctionCall : Rule|TopLevelRuleModifier,
    JsonArrayAggregateFunctionCall : Rule|TopLevelRuleModifier,
    CountAggregateFunctionCall : Rule|TopLevelRuleModifier,
    GroupConcatAggregateFunctionCall : Rule|TopLevelRuleModifier,
    ...
    Expression3_Arguments : Rule|TopLevelRuleModifier,
    Expression4_Arguments : Rule|TopLevelRuleModifier,
    Expression1To2_Arguments : Rule|TopLevelRuleModifier,
    Expression2To3_Arguments : Rule|TopLevelRuleModifier,
    ...
    Substring_Arguments_From : Rule|TopLevelRuleModifier,
    Substring_Arguments_Comma : Rule|TopLevelRuleModifier,
    ForLength : Rule|TopLevelRuleModifier,
    WeightString_Arguments : Rule|TopLevelRuleModifier,
    WeightString_Arguments_Default : Rule|TopLevelRuleModifier,
    WeightString_Arguments_AsChar : Rule|TopLevelRuleModifier,
    WeightString_Arguments_AsBinary : Rule|TopLevelRuleModifier,
    WeightString_Arguments_Undocumented : Rule|TopLevelRuleModifier,
    WeightStringCastLength : Rule|TopLevelRuleModifier,
    WeightString_Levels : Rule|TopLevelRuleModifier,
    WeightString_Level_List1 : Rule|TopLevelRuleModifier,
    WeightString_Level_Range : Rule|TopLevelRuleModifier,
    WeightString_Level_Flag : Rule|TopLevelRuleModifier,
    WeightString_Level_Item : Rule|TopLevelRuleModifier,
    OrderExpression : Rule|TopLevelRuleModifier,
    OrderExpressionList1 : Rule|TopLevelRuleModifier,
    OrderByClause : Rule|TopLevelRuleModifier,
    NumberAggregate_Arguments_Expression : Rule|TopLevelRuleModifier,
    NumberAggregate_Arguments : Rule|TopLevelRuleModifier,
    Aggregate_Arguments_Expression : Rule|TopLevelRuleModifier,
    Aggregate_Arguments : Rule|TopLevelRuleModifier,
    JsonObjectAggregate_Arguments : Rule|TopLevelRuleModifier,
    CountAggregate_Arguments_All_Expression : Rule|TopLevelRuleModifier,
    CountAggregate_Arguments_All : Rule|TopLevelRuleModifier,
    CountAggregate_Arguments_Distinct : Rule|TopLevelRuleModifier,
    CountAggregate_Arguments : Rule|TopLevelRuleModifier,
    GroupConcatAggregate_Arguments : Rule|TopLevelRuleModifier,
    GroupConcatAggregate_Separator : Rule|TopLevelRuleModifier,
    ...
    ColonEqual : Rule|TopLevelRuleModifier
}
