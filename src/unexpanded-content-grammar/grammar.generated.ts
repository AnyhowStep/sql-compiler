...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "MacroIdentifier$ebnf$1$subexpression$1$ebnf$1$subexpression$1", "symbols": [Dot, "Identifier"]},
    ...
    {"name": "MacroIdentifier$ebnf$1$subexpression$1", "symbols": [Dot, "Identifier", "MacroIdentifier$ebnf$1$subexpression$1$ebnf$1"]},
