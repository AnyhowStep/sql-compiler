import {AlterTableUpgradePartitioning, SyntaxKind} from "../../../../parser-node";
 ...
 */
makeCustomRule(SyntaxKind.AlterTableUpgradePartitioning)
    .addSubstitution(
        [
            TokenKind.UPGRADE,
            TokenKind.PARTITIONING,
        ] as const,
        (data) : AlterTableUpgradePartitioning => {
            return {
                ...getTextRange(data),
