...
+ [ ] [`        | '-' NUM_literal`]()
+ [ ] [`literal:`]()
+ [ ] [`          text_literal `](test-fixture/parse-2/expression/simple-expression/literal/text-literal)
+ [ ] [`        | NUM_literal`](test-fixture/parse-2/expression/simple-expression/literal/number-literal)
+ [ ] [`        | temporal_literal`]()
+ [ ] [`        | NULL_SYM`]()
+ [ ] [`        | FALSE_SYM`]()
+ [ ] [`        | TRUE_SYM`]()
