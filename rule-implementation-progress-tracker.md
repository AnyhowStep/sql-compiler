...
+ [x] [`        | '+' simple_expr %prec NEG`](test-fixture/parse-2/expression/simple-expression/prefix-simple-expression)
+ [x] [`        | '-' simple_expr %prec NEG`](test-fixture/parse-2/expression/simple-expression/prefix-simple-expression)
+ [x] [`        | '~' simple_expr %prec NEG`](test-fixture/parse-2/expression/simple-expression/prefix-simple-expression)
+ [x] [`        | not2 simple_expr %prec NEG`](test-fixture/parse-2/expression/simple-expression/not-2-simple-expression)
+ [ ] [`        | '(' subselect ')'`]()
+ [x] [`        | '(' expr ')'`](test-fixture/parse-2/expression/simple-expression/parenthesized-expression)
+ [x] [`        | '(' expr ',' expr_list ')'`](test-fixture/parse-2/expression/simple-expression/row-simple-expression)
+ [x] [`        | ROW_SYM '(' expr ',' expr_list ')'`](test-fixture/parse-2/expression/simple-expression/row-simple-expression)
+ [ ] [`        | EXISTS '(' subselect ')'`]()
+ [ ] [`        | ''`]()
+ [ ] [`        | MATCH ident_list_arg AGAINST '(' bit_expr fulltext_options ')'`]()
+ [x] [`        | BINARY simple_expr %prec NEG`](test-fixture/parse-2/expression/simple-expression/prefix-simple-expression)
